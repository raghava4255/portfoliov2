...
const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'CI/CD & Environment Config', level: 75 },
      { name: 'Linux Basics', level: 80 },
    ],
  },
  {
    title: 'Cloud & Infrastructure',
    icon: <Cloud className="w-5 h-5 text-sky-400" />,
    colorClass: 'hover:border-sky-500/40 hover:shadow-[0_0_25px_rgba(56,189,248,0.1)]',
    skills: [
      { name: 'AWS Concepts', level: 70 },
      { name: 'VPS Hosting (Hostinger)', level: 80 },
